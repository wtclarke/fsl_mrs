...
setup(name='FSL_MRS',
      ...
      packages=['fsl_mrs','fsl_mrs.utils','fsl_mrs.utils.mrs_io','fsl_mrs.utils.stats','fsl_mrs.utils.preproc','fsl_mrs.denmatsim','fsl_mrs.mmbasis','fsl_mrs.aux'],
      package_data={'fsl_mrs.utils':['mrs_report_template.html','metabolites.pickle'],'fsl_mrs.denmatsim':['spinSystems.json'],
      'fsl.mmbasis':['mmbasis.json'],
